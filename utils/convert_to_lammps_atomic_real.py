...
def main():
    if len(sys.argv) < 3:
        print("Usage: python convert_to_lammps_atomic_real.py <input.atoms> <output.atoms_lammps> [sigma]")
    ...
    print(f"Writing atomic-style configuration (real units, sigma={sigma}) to '{output_path}'...")
    with open(output_path, 'w') as f:
        f.write("# LAMMPS atomic data file for site-site patchy model (5-site representation, real units, centered)\n\n")
